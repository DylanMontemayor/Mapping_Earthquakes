...
let torontoData = "https://raw.githubusercontent.com/DylanMontemayor/Mapping_Earthquakes/Mapping_GeoJSON_Linestrings/torontoRoutes.json";
...
// Creating a GeoJSON layer with the retrieved data.
  ...
  onEachFeature: function(feature,layer){
    console.log(feature);
    console.log(layer);
    layer.bindPopup("<h2>" + "Airline: " +feature.properties.airline +"</h2> <hr> <h3> </h3> Destination: " + feature.properties.dst);
  }
}).addTo(map);
});
